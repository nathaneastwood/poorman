...
### `mutate()`
    ...
    mtcars %>% mutate(mpg_squared = mpg ^ 2)
    #                      mpg cyl  disp  hp drat    wt  qsec vs am gear carb
    ...
    # Merc 450SL               299.29
    # Merc 450SLC              231.04
    # Cadillac Fleetwood       108.16
    # Lincoln Continental      108.16
    # Chrysler Imperial        216.09
    # Fiat 128                1049.76
    # Honda Civic              924.16
    # Toyota Corolla          1149.21
    # Toyota Corona            462.25
    # Dodge Challenger         240.25
    # AMC Javelin              231.04
    # Camaro Z28               176.89
    # Pontiac Firebird         368.64
    # Fiat X1-9                745.29
    # Porsche 914-2            676.00
    # Lotus Europa             924.16
    # Ford Pantera L           249.64
    # Ferrari Dino             388.09
    # Maserati Bora            225.00
    # Volvo 142E               457.96
